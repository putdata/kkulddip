...
const PaymentSuccess = () => {
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4">
        <div className="rounded-lg bg-white p-8 text-center shadow-lg">
          <div className="mb-4 h-16 w-16 animate-spin rounded-full border-4 border-amber-500 border-t-transparent mx-auto"></div>
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4">
      <div className="rounded-lg bg-white p-8 text-center shadow-lg">
        <div className="mb-4 h-16 w-16 rounded-full bg-green-100 flex items-center justify-center mx-auto">
          <span className="text-2xl">✅</span>
        </div>
        <h2 className="mb-2 text-xl font-semibold text-green-600">결제 완료!</h2>
