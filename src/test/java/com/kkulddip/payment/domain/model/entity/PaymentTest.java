...
class PaymentTest {
    ...
    void approve_ReadyStatus_Success() {
        ...
        String requestedAt = "2024-01-01T10:00:00";
        String approvedAt = "2024-01-01T10:01:00";
    ...
    void approve_NotReadyStatus_ThrowsException() {
        ...
        // when & then
        assertThatThrownBy(() -> payment.approve(paymentKey, method, requestedAt, approvedAt, receiptUrl))
