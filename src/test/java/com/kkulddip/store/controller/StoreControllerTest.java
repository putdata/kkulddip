...
class StoreControllerTest {
    ...
    void getStoresByCategory() throws Exception {
        ...
        // when & then
        mockMvc.perform(get("/api/v1/store/category/유기농")
    ...
    void getStoreDetail_NotFound() throws Exception {
        ...
        // when & then
        mockMvc.perform(get("/api/v1/store/999")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void getStoreDetail_InvalidId() throws Exception {
        ...
        // when & then
        mockMvc.perform(get("/api/v1/store/0")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest());
    }
    ...
    void getStoreDdipBoxes() throws Exception {
        ...
        // when & then
        mockMvc.perform(get("/api/v1/store/1/ddipboxes")
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true))
    ...
    void getStoreDdipBoxes_StoreNotFound() throws Exception {
        ...
        // when & then
        mockMvc.perform(get("/api/v1/store/999/ddipboxes")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }
    ...
    void getStoreDetail_InvalidPathParameter() throws Exception {
        // when & then
        mockMvc.perform(get("/api/v1/store/invalid")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest());
    }
