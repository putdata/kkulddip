...
public interface OwnerSettlementApi {
    ...
    @Operation(
        summary = "특정 가게 월별 정산 리스트 조회",
        description = "Owner가 소유한 특정 가게의 기간별 월별 정산 정보를 리스트로 조회합니다. 최대 12개월까지 조회 가능하며, 각 월별 매출, 주문 수, 전월 대비 성장률과 전체 기간의 트렌드 분석을 제공합니다."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "월별 정산 리스트 조회 성공",
            content = @Content(
                mediaType = "application/json",
                schema = @Schema(
                    example = """
                        {
                          ...
                          "body": {
                            ...
                            "monthlyData": [
                              {
                                ...
                                "orderCount": 80,
                                "avgOrderAmount": 15000.0,
                                "previousMonthRevenue": 1000000,
                                "previousMonthOrderCount": 70,
                                "revenueGrowthRate": 20,
                                "orderCountGrowthRate": 14
                              },
                              {
                                "period": [2024, 5],
                                ...
                                "avgOrderAmount": 15000.0,
                                "previousMonthRevenue": 1200000,
                                "previousMonthOrderCount": 80,
                                "revenueGrowthRate": 12,
                                "orderCountGrowthRate": 12
                              },
                              {
                                "period": [2024, 6],
                                "totalRevenue": 1500000,
                                "orderCount": 100,
                                "avgOrderAmount": 15000.0,
                                "previousMonthRevenue": 1350000,
                                "previousMonthOrderCount": 90,
                            ...
                            "totalOrderCount": 270,
                            "averageMonthlyRevenue": 1350000.0,
                            "overallGrowthRate": 25.0
                          }
                        }
                        """
                )
                    ...
                    example = """
                        {
                          ...
                          "body": [
                            {
                              "field": "endYear",
                              "message": "종료 년도는 시작 년도보다 이후여야 합니다",
                              "rejectedValue": 2023
                            }
                          ]
                        }
    ...
    ApiResponse<MonthlySettlementResponse> getStoreMonthlySettlement(
        @Parameter(hidden = true) @AuthenticationPrincipal JwtUserInfo userInfo,
        @Parameter(description = "가게 ID") @PathVariable Long storeId,
