...
public interface AnalyticsService {
    ...
    /**
     * 특정 스토어의 당일 분석 데이터를 제공합니다.
     *
     * @param storeId 분석할 스토어 ID
     * @param targetDate 분석할 날짜 (null인 경우 오늘 날짜)
     * @return 당일 매출 현황, 인기 상품, 재고 현황, 수익성 분석
     */
    DailyAnalyticsResponseDto generateDailyAnalytics(Long storeId, LocalDate targetDate);
}
