package com.kkulddip.payment.domain.model.entity;
...
public class Payment {
    ...
    public Payment(String orderId, String orderName, Money amount, String customerName, String customerEmail, String callbackUrl, String failUrl) {
    ...
    // 재구성을 위한 생성자
    public Payment(PaymentKey paymentKey, String orderId, String orderName, Money amount,
                   String customerName, String customerEmail, PaymentStatus status, PaymentMethod method,
                   String requestedAt, String approvedAt, String receiptUrl, String callbackUrl, String failUrl,
