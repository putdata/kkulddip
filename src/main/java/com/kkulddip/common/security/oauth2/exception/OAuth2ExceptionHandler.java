...
public class OAuth2ExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse<Void>> handleOAuth2AuthenticationException(
    ...
    public ResponseEntity<ErrorResponse<Void>> handleOAuth2UserInfoException(
            OAuth2UserInfoException ex) {
    ...
    public ResponseEntity<ErrorResponse<Void>> handleUnsupportedOAuth2ProviderException(
            UnsupportedOAuth2ProviderException ex) {
