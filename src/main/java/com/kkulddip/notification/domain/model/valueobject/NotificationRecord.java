package com.kkulddip.notification.domain.model.valueobject;
...
public class NotificationRecord {
     ...
     * 발송 성공 처리
     */
    public NotificationRecord markAsSent() {
     ...
     * 발송 실패 처리
     */
    public NotificationRecord markAsFailed(String errorMessage) {
        return this.toBuilder()
            .isSent(false)
            .sentAt(null)
